    ...
    <div ref={searchRef} className="relative max-w-3xl w-full mx-auto px-4 hidden lg:block">
      <motion.div 
        ...
        animate={isSearchOpen ? { 
          ...
          borderColor: "rgba(191, 161, 106, 0.2)",
          scale: 1
        } : {
          width: "240px",
          height: "48px",
        ...
        onClick={() => {
          if (!isSearchOpen) {
            ...
            controls.start({ scale: [0.98, 1], transition: { duration: 0.2 } });
        ...
        className={`flex items-center relative overflow-hidden mx-auto
          ...
          hover:shadow-xl transition-all duration-300 group/search
          ${isSearchOpen ? 'ring-1 ring-[#bfa16a]/20 ring-offset-2 ring-offset-transparent' : ''}`}
      >
        <div className="flex items-center w-full px-2 gap-2">
          ...
          >
            <motion.div
              ...
              className="p-2 rounded-xl bg-gradient-to-br from-[#bfa16a]/10 to-transparent transition-all duration-300"
            >
              <Search size={20} className="text-[#bfa16a]" />
            </motion.div>
            {!isSearchOpen && (
              <motion.div 
                initial={{ opacity: 0 }}
          ...
          >
            <input
              ...
              ref={inputRef}
              className="w-full bg-transparent border-none outline-none text-black/90 placeholder-black/40 text-base cursor-text select-text"
            />
          </motion.div>
      ...
      <AnimatePresence>
        {isSearchOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 mt-2 mx-4 bg-white/95 rounded-2xl shadow-2xl border border-[#bfa16a]/20 backdrop-blur-2xl overflow-hidden z-50
            ring-1 ring-black/5 ring-offset-2 ring-offset-white/50"
          >
            <div className="p-4">
              ...
              <div className="space-y-2 max-h-[450px] overflow-y-auto">
                {searchResults.map((item) => (
                  <motion.div
                    ...
                    className="flex items-center gap-4 p-3 cursor-pointer rounded-xl hover:bg-[#bfa16a]/5 transition-all duration-300 group
